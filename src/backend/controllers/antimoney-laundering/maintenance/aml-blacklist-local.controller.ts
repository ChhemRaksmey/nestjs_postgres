...
@Controller('aml/maintenance/blacklist/local')
export class ControllerAMLMaintenanceBlacklistLocal {
  ...
  async list(@Query('search') search: string, @Res() res: Response, @Req() req: Request) {
    ...
    return renderView(res, 'anti-money-laundering/maintenance/blacklist-local/index', { 
