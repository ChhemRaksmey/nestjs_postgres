...
@Controller('aml/front-office/customer-detected-role-alert')
export class ControllerAMLFrontOfficeCustomerDetectedAlert {
  ...
  async list(@Query('search') search: string, @Res() res: Response, @Req() req: Request) {
    ...
    return renderView(res, 'anti-money-laundering/front-office/customer_detected/index', { 
