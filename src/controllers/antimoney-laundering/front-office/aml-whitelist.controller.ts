...
@Controller('aml/front-office/whitelist')
export class ControllerAMLFrontOfficeWhiteList {
  ...
  async list(@Query('search') search: string, @Res() res: Response, @Req() req: Request) {
    ...
    return renderView(res, 'anti-money-laundering/front-office/whitelist/index', { 
